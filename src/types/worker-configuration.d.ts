/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/types/worker-configuration.d.ts --env-interface CloudflareBindings` (hash: 4546053ccf0cc5e0a3a61d9e75ec68f7)
// Runtime types generated with workerd@1.20250712.0 2025-06-04 nodejs_compat,nodejs_compat_populate_process_env
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_API_KEY" | "GROQ_API_KEY" | "HELIUS_API_KEY" | "TAVILY_API_KEY" | "TELEGRAM_BOT_TOKEN" | "DATABASE_URL" | "CRON_SECRET" | "VYBE_API_KEY" | "ADMIN_API_KEY">> {}
}
